  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 py-32">
      <div className="text-center  mb-12 ">
        <h1 className="text-4xl lg:text-5xl font-blod text-gray-800 mb-4 ">
          임원진 소개
        </h1>
      ...
      <div className="flex flex-col md:flex-row gap-12 mb-24 items-center">
        <div className="md:w-2/3 ">
          ...
          <div className="text-2xl text-gray-500 space-y-6">
            <p>안녕하십니까, ABC Company 대표이사 김대표입니다.</p>
            <p>
              저희 ABC Company는 20년 이상의 전기 산업 경력을 바탕으로, 혁신적인
              기술과 서비스를 통해 고객 여러분 께 최상의 가치를 제공하기 위해
              노력하고 있습니다.
            </p>
            <p>
            ...
            <p className=" mt-8">ABC Company 대표이사 김대표 드림</p>
          </div>
        </div>
      ...
      <div className="mb-24 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 ">
          {executives.map((executive, index) => (
            <div
              key={index}
              className="flex flex-col bg-white  shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transtion-shaodw duration-300  gap-4"
            >
