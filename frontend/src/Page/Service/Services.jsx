    ...
    <div className="container mx-auto px-4 py-32 max-w-7xl ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        {servicesList.map((service) => (
          <div
            key={service.id}
            className="bg-white p-8 rounded-lg shadow-lg hover:-translate-y-2 duration-300"
          >
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-600">다양한 산업 분야의 프로젝트</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">
              전문가 팀
      ...
      <div className="mt-32 bg-blue-600 rounded-2xl p-12 text-center text-white">
        ...
        <butto className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-300">
          무료 상담 신청하기
        </butto>
      </div>
    </div>
